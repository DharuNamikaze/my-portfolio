...
const Footer = () => {
  return (
    <footer className="footer p-6 text-center text-sm mt-auto">
      <div className="links flex justify-center gap-5">
        ...
        <Link href="https://linkedin.com/in/dharunn" target="_blank" aria-label="LinkedIn">
          <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <Link href="https://x.com/Dharu_Namikaze" target="_blank" aria-label="Twitter">
          <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <br />
      <p className="flex justify-center">© {new Date().getFullYear()} Dharun R - Personal Portfolio. All rights Unreserved.</p>
    </footer>
  );
};
